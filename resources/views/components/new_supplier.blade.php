    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h5 class="modal-title" id="newSupplierModalLabel">Create Supplier</h5>
            ...
            <form action="#" method="POST" id="supplierForm">
                ...
                <div class="modal-body pt-4">
                    <div class="mb-3">
                        <label for="supplierName" class="form-label fw-semibold">Name:</label>
...
<style>
    ...
    #newSupplierModal .form-control:focus {
        border-color: #ced4da;
    ...
    #newSupplierModal .btn-secondary {
        background-color: #e9ecef;
        border-color: #e9ecef;
        color: #495057;
    }

    #newSupplierModal .btn-secondary:hover {
        background-color: #dde0e3;
        border-color: #dde0e3;
    }

    #newSupplierModal .btn-primary {
        background-color: #4a7c9e;
        border-color: #4a7c9e;
    }

    #newSupplierModal .btn-primary:hover {
